...
BUFF_SIZE = 65536
client_socket = socket.socket(socket.AF_INET,socket.SOCK_DGRAM) #foloseste UDP(SOCK_DGRAM) sau TCP (SOCK_STREAM) 
client_socket.setsockopt(socket.SOL_SOCKET,socket.SO_RCVBUF,BUFF_SIZE)
host_name = socket.gethostname()
host_ip = '172.20.10.14'#  socket.gethostbyname(host_name)
print(host_ip)
port = 9999
message = b'Hello'
